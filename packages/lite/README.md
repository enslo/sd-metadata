...
- **Tiny**: **6,934 bytes** minified IIFE build
...
1. Copy the contents of `dist/index.global.js` (or download from [npm](https://cdn.jsdelivr.net/npm/@enslo/sd-metadata-lite@1.4.0/dist/index.global.js))
...
Prompt and parameter fields are included only when present in the source metadata.
